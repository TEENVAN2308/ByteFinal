        ...
        <>
            ...
            <div className="about-box2 mt-3">
                    ...
                    -<strong> Task completion(10 marks) :</strong> Does the Software/System work as intended? Does it perform the desired task or solve the problem?
                     <br/> -<strong> Approach to solving the problem(10 marks) :</strong> Defines algorithm used to solve the problem, and is the code well-organised,readable and maintable? <br />
                     <br/> -<strong> Approach to solving the problem(10 marks) :</strong> Efficiency(10 marks) <br /></p>
